...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/member/increase"],{"218e":function(n,e,t){},"356c":function(n,e,t){"use strict";(function(n){t("3574"),t("921b");o(t("66fd"));var e=o(t("95f9"));function o(n){return n&&n.__esModule?n:{default:n}}n(e.default)}).call(this,t("6e42")["createPage"])},"7e1a":function(n,e,t){"use strict";var o=t("218e"),i=t.n(o);i.a},"95f9":function(n,e,t){"use strict";t.r(e);var o=t("c900"),i=t("f122");for(var a in i)"default"!==a&&function(n){t.d(e,n,function(){return i[n]})}(a);t("7e1a");var c=t("2877"),u=Object(c["a"])(i["default"],o["a"],o["b"],!1,null,"73d5e412",null);e["default"]=u.exports},a7cd:function(n,e,t){"use strict";(function(n,o){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var i=function(){return t.e("components/uni-nav-bar/uni-nav-bar").then(t.bind(null,"ae6d"))},a=function(){return t.e("components/commonAvatar").then(t.bind(null,"a5d8"))},c=function(){return t.e("components/zz-switchc/zz-switchc").then(t.bind(null,"9d66"))},u=function(){return t.e("components/uni-popup/uni-popup").then(t.bind(null,"10aa"))},s={data:function(){return{rightIcon:"/static/ling.png",dot:!0,memberList:[{icon:"/static/member_icon1.png",title:"投资钱包",url:"/pages/mine/investWallet",value:"600000"},{icon:"/static/member_icon2.png",title:"APP钱包",url:"/pages/mine/wallet",value:"16000000"}],is_apply:0,is_pass:0,price:"",password:"",input_type:"",photo:"",bank_account:"4412324354522"}},components:{uniNavBar:i,commonAvatar:a,switchc:c,uniPopup:u},methods:{toListLink:function(e){n.navigateTo({url:this.memberList[e].url})},apply:function(){this.is_apply=1},switchchange:function(n){console.log(o(n," at pages\\member\\increase.vue:131")),1==n.value?this.input_type=1:this.input_type=0},uploadImg:function(){var e=this;n.chooseImage({count:1,sizeType:["original"],sourceType:["album"],success:function(n){console.log(o(JSON.stringify(n.tempFilePaths)," at pages\\member\\increase.vue:145")),e.photo=n.tempFilePaths[0]}})},copyAccount:function(){var e=this;n.setClipboardData({data:e.bank_account,success:function(){console.log(o("success"," at pages\\member\\increase.vue:172")),e.$api.msg("复制成功，快去粘贴吧！")}}),n.getClipboardData({success:function(n){console.log(o(n.data," at pages\\member\\increase.vue:178"))}})},applyConfirm:function(){this.is_apply=1},lookAccount:function(){this.$refs.popup.open()},cancelPopup:function(){this.$refs.popup.close()},okPopup:function(){this.$refs.popup.close()}}};e.default=s}).call(this,t("6e42")["default"],t("0de9")["default"])},c900:function(n,e,t){"use strict";var o=function(){var n=this,e=n.$createElement;n._self._c},i=[];t.d(e,"a",function(){return o}),t.d(e,"b",function(){return i})},f122:function(n,e,t){"use strict";t.r(e);var o=t("a7cd"),i=t.n(o);for(var a in o)"default"!==a&&function(n){t.d(e,n,function(){return o[n]})}(a);e["default"]=i.a}},[["356c","common/runtime","common/vendor"]]]);
});
